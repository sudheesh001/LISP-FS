...
var defaultFileSystemFrame = {
	'__fileSystem': {
		...
		'/': {
			'readme.txt': {
				'type': 'file',
				'contents': 'LISP Machine by Sudheesh Singanamalla. Thanks to Jakub Jankiewicz for his jQuery Terminal plugin (distributed under LGPL).' +
					'For more information check out the git repo'
			},
			'cleanup.s': {
				'type': 'file',
